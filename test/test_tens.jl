@testsection "Tens" begin
    ...
    @test SymPy.simplify(components(V, b, (:cont,))) ==
          [(-v1 + v2 + v3) / 2, (v1 - v2 + v3) / 2, (v1 + v2 - v3) / 2]
    @test SymPy.simplify(components(V, b, (:cov,))) == [v2 + v3, v1 + v3, v1 + v2]
    @test SymPy.simplify(components(V, bn, (:cov,))) ==
    ...
    @test SymPy.simplify(components(T, b, (:cov, :cov))) == [
    ...
    @test SymPy.simplify(components(T, b, (:cont, :cov))) ==
          [
